...
m13 = Meetup.create(user_id:u5.id,company_id:c4.id,capacity: 1, discount_percent:20, this_weeks_event:" film", book:"nil", film:"unbreakable", business: "nil", tech:"nil", art:"nil", photography:"travel_photography", learning: "nil")
m2 = Meetup.create(user_id:u4.id,company_id:c6.id,capacity: 2, discount_percent:20, this_weeks_event:"art", book:"nil" , film: "jumanji", business: "nil", tech:"go", art:"going to withney musium", photography:"street_photography", learning: "nil")
...
m4 = Meetup.create(user_id:u5.id,company_id:c8.id,capacity: 4, discount_percent:20, this_weeks_event:"phtography", book:"nil" , film: "1917", business: "nil", tech:"css", art:"nil", photography:"nil", learning: "nil")
...
m6 = Meetup.create(user_id:u4.id,company_id:c6.id,capacity: 3, discount_percent:20, this_weeks_event:" tech guys ", book:"nil" , film: "star_wars", business: "nil", tech:"java_script", art:"nil", photography:"nil", learning: "nil")
m7 = Meetup.create(user_id:u5.id,company_id:c2.id,capacity: 4, discount_percent:20, this_weeks_event:"learning how to cook", book:"nil" , film: "forrest_gump", business: "nil", tech:"ruby", art:"nil", photography:"nil", learning: "nil")
m8 = Meetup.create(user_id:u4.id,company_id:c1.id,capacity: 5, discount_percent:20, this_weeks_event:"Watching Football", book:"nil" , film: "a_beautiful_mind", business: "nil", tech:"python", art:"nil", photography:"nil", learning: "nil")  
